...
import { courseEntityDetailScreen, courseEntityEditScreen } from '../../../navigation/layouts'
import CourseActions from './course.reducer'
import styles from './course-entity-screen-style'
import AlertMessage from '../../../shared/components/alert-message/alert-message'

// More info here: https://facebook.github.io/react-native/docs/flatlist.html

class CourseEntityScreen extends React.PureComponent {
  constructor (props) {
    super(props)
  ...
  navigationButtonPressed ({ buttonId }) {
    courseEntityEditScreen({ entityId: null })
  }
  /* ***********************************************************
  * STEP 2
  ...
  *************************************************************/
  renderRow ({ item }) {
    return (
      <TouchableOpacity onPress={courseEntityDetailScreen.bind(this, { entityId: item.id })}>
  ...
  *************************************************************/
  ...
  renderEmpty = () =>
    <AlertMessage title='No Courses Found' show={!this.props.fetching} />
...
export default connect(mapStateToProps, mapDispatchToProps)(CourseEntityScreen)
